...
/*#1-Login successfully web order page parameterize username and password in feature file
        ...
        #5 choose the delivery option "My House" and validate address(contains) "3137 Laguna"
